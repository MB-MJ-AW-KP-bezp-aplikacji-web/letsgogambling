...
def roulette(request):
    ...
    return render(request, "casino/roulette/index.html", {"balance": user.balance, "result": result, "error": err, "last_bet": bet if bet is not None else 10, "last_choice": request.session.get("choice")})
